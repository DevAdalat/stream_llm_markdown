...
class RenderMarkdownThematicBreak extends RenderMarkdownBlock {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    switch (style) {
      ...
      case HorizontalRuleStyle.dotted:
        _drawDottedLine(canvas, offset.dx + indent, lineY, lineWidth, paint, thickness);
    }
  }
  
  void _drawDashedLine(ui.Canvas canvas, double x, double y, double width, Paint paint) {
    const dashWidth = 8.0;
    const dashSpace = 4.0;
    var currentX = x;
  ...
  void _drawDottedLine(ui.Canvas canvas, double x, double y, double width, Paint paint, double thickness) {
